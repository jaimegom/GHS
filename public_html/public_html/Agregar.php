...
<div class="form-top-left" style="color:white">
    <div class="row" >
        <div class="col-sm-8 col-sm-offset-2 text" style="color:white">
            <h1 style="color:white"><strong>GHS</strong> Agregar </h1>
    ...
    <form class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-9">
                <input type="password" class="form-control" id="inputTelefono" placeholder="Telefono">
            </div>
        </div>
        <div class="form-group">
