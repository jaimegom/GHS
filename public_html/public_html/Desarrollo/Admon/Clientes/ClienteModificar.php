...
{
    $id_cliente = $_GET['edit_id'];
    $rowCliente = getByIDCliente($id_cliente);
    $nombreCliente= $rowCliente['nombre_cliente'];
    $correoElectronico = $rowCliente['correo_electronico'];
    ...
    <form method='post'>
        ...
        <table class='table table-bordered'>
            ...
            <tr>
                ...
                <td><input type='text' name='correoElectronico' class='form-control' value="<?php echo $correoElectronico; ?>" required></td>
            </tr>
