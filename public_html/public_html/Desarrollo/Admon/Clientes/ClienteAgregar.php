    ...
    <form method='post'>
        ...
        <table class='table table-bordered'>
            ...
            <tr>
                ...
                <td><input type='text' name='nombreCliente' class='form-control' required></td>
            </tr>
...
if(isset($_POST['btn-save']))
{
    if($_POST['nombreCliente']&& $_POST['correoElectronico']&& $_POST['Telefono']&&$_POST['Direccion'] ){
        ...
        if(agregarCliente($_POST['nombreCliente'], $_POST['correoElectronico'], $_POST['Telefono'],$_POST['Direccion'] )){
           header("Location: clienteAgregar.php?inserted");
       }else{
           header("Location: clienteAgregar.php?failure");
       }
